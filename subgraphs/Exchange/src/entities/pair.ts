...
import { BIG_DECIMAL_ZERO, BIG_INT_ZERO, FACTORY_ADDRESS, WHITELIST } from '../../../../packages/constants'
...
export function getPair(
  ...
  if (pair === null) {
    ...
    const token0Address: Address = (token0FromParams || pairContract.token0())!
    ...
    const token1Address: Address = (token1FromParams || pairContract.token1())!
